...
Use the structured format specified in `references/api_template.md`. Provide a unified documentation file that covers all necessary sections:

- **Title & Overview**
- **Authentication**: Key headers/payloads
- **Flow**: High-level process (Optional)
- **API Endpoints**: Detailing Path, Method, Request/Response Tables, and JSON Examples
- **Error Responses**: Detailed structured error shapes
